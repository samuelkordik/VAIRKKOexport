...
for archival purposes or imported to other systems.
...
#> Current VAIRKKO credentials:
#>  ----------------------------
#>  Company ID: 366
#>  Username: skordik@ccems.com
#>  ----------------------------
#> Run update_authentication() in console to store credentials.
#> ── Attaching packages ──────────────────────────────────── vairkkoexport0.1.0 ──
#> ✓ tidyverse 1.3.0     ✓ rvest     1.0.0
#> 
#> Attaching package: 'vairkkoexport'
